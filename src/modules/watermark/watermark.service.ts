...
export class WatermarkService {
  ...
  constructor() {
    const configured = config.images.previewMaxSize;
    const resolved =
  ...
  async applyWatermark(
    ...
    return this.applyWatermarkInternal(imageBuffer, text, mimeType);
  }
  ...
  async applyPreviewWatermark(
    ...
    return this.applyWatermarkInternal(imageBuffer, 'PREVIEW', mimeType, {
