...
const expectedSchema: Record<string, string[]> = {
  ...
  orders: ['id', 'order_number', 'user_id', 'session_id', 'customer_name', 'customer_email', 'customer_phone', 'street_address', 'barangay', 'city', 'province', 'postal_code', 'delivery_zone', 'grid_config_id', 'generation_job_id', 'tile_assignments', 'product_price', 'delivery_fee', 'total_amount', 'item_count', 'payment_status', 'order_status', 'payment_method', 'maya_checkout_id', 'maya_payment_id', 'paymongo_checkout_id', 'paymongo_payment_id', 'payment_provider', 'composed_image_key', 'download_count', 'max_downloads', 'admin_downloaded_at', 'admin_downloaded_by', 'admin_printed_at', 'admin_printed_by', 'paid_at', 'shipped_at', 'delivered_at', 'created_at', 'updated_at'],
